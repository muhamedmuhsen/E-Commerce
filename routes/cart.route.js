...
import {
    addToCartValidator, updateProductQuantityValidator, applyCouponValidator, removeItemFromCartValidator,
...
router
    ...
    .delete(removeItemFromCartValidator,CartController.wrap(CartController.removeItem));
